...
The contact page (`contact.html`) sends messages through **Web3Forms**, a free
...
**Where the key lives.** `contact.html` contains one line:
...
paste it into that one line in `contact.html`. Nothing else changes.
